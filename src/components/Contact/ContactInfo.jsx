...
const API_ENDPOINT = `${import.meta.env.VITE_API_URL}/send-email`; // TODO: add your contact form API endpoint URL
...
const ContactInfo = () => {
  ...
  return (
    ...
    //   </div>
    // </main>
    <section ref={contactCard} className="text-gray-600 body-font relative">
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            ...
            <button
              type="submit"
              className="text-white cursor-pointer bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
